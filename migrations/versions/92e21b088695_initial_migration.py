...
Revision ID: 92e21b088695
Revises: 
Create Date: 2025-12-19 23:31:27.849818
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_employeeid'), ['employeeid'], unique=True)
    ...
    with op.batch_alter_table('employee_profile', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_employee_profile_email'), ['email'], unique=True)
...
def downgrade():
    ...
    with op.batch_alter_table('employee_profile', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_employee_profile_email'))

    op.drop_table('employee_profile')
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_user_role'))
        batch_op.drop_index(batch_op.f('ix_user_employeeid'))
